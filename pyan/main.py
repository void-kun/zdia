...
def main(cli_args=None):
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=False,
        dest="group_by_toplevel",
        help="group modules by their top-level package (e.g. shared_module.* under shared_module)",
    )
    ...
    graph_options = {
        ...
        "group_by_toplevel": known_args.group_by_toplevel,
